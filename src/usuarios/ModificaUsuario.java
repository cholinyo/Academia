...
/**
 * Servlet implementation class modifica_usuario
 */
@WebServlet("/modifica_usuario")
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		synchronized (fuente_datos) {
			try {
				...
				String qry="UPDATE usuarios SET login=?, password=?, nombre=?, apellidos=?, rol=? WHERE idusuario=?"; 
