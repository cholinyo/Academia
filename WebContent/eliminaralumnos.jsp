...
<body>
	...
	<%
		...
		Asignatura asignatura = Asignatura.getAsignatura(idasignatura); //Recoge los que no están matriculados
	%>
	<div class="panel panel-body">
		<div class="seleccion col-rs-4 panel panel-default">
			<div class="panel-heading">
				<h2>
					Desmatricular en la asignatura
				...
				<table class="table table-striped">
					...
					<%
						...
						for (int i = 0; i < lista.size(); i++) {
							...
							if (Matricula.compruebaMatricula(id, idasignatura)) {
								out.println("<tr>");
								...
								out.println("<td><form action='DesmatriculaAlumno' method='post'>");
								out.println("<input type='hidden' name='idusuario' value='" + id + "'>");
								out.println("<input type='hidden' name='idasignatura' value='" + idasignatura + "'>");
								out.println("<input type='submit' name='button' value='Desmatricula'></form><td>");
								out.println("</tr>");
							}
						}
					%>
